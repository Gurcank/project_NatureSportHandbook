const SIZES = [640, 960, 1280, 1920, 2880, 3648] as const;
 ...
 * smaller screens a proportionate copy — down to 640px, so a phone does not
 * pull a desktop-sized photograph. The original is 3648px wide, which
...
export default function Meadow() {
  return (
    <div aria-hidden="true" className="meadow">
      ...
      <img
        src="/images/meadow/grass-1280.jpg"
