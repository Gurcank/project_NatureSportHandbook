        ...
        <div className="relative mx-auto flex min-h-[calc(100vh-2rem)] w-full max-w-6xl flex-col items-center justify-start pt-6">
          <div className="relative z-10 w-full max-w-4xl px-2 text-center">
            ...
            >
              ...
              <div
                className="pointer-events-none absolute left-[1%] top-[10%] h-[2px] opacity-55 bg-[linear-gradient(90deg,rgba(248,230,198,0.3),rgba(248,230,198,0.08),rgba(248,230,198,0.28))]"
                style={{ width: 'calc(87% - 2px)' }}
              />
              <div
                className="pointer-events-none absolute left-[1%] bottom-[10%] h-[2px] opacity-90 bg-[linear-gradient(90deg,rgba(54,33,16,0.44),rgba(54,33,16,0.18),rgba(54,33,16,0.4))]"
                style={{ width: 'calc(87% - 2px)' }}
              />
              ...
              leftContent={
                <div>
                  ...
                  <p
                    ...
                    className="text-base leading-7 font-serif mb-6"
                  >
                    {language === 'tr'
                  ...
                  <div className="flex flex-col gap-4 pt-2">
                    <Link href="/nature/animals">
                      <div className="group/link relative inline-flex cursor-pointer items-center gap-2 px-2 py-2">
                        ...
                        <span
                          className="relative text-base text-[#5a5a5a]"
                          style={{
                            fontFamily: 'var(--font-kalam), "Segoe Print", "Bradley Hand", cursive',
                          }}
                        >
